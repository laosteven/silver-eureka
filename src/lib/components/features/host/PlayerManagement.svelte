<script lang="ts">
  ...
  $effect(() => {
    sortedPlayers = (p.players ? [...p.players] : []).sort((a, b) => b.score - a.score);
  });
...
<div>
  <Accordion.Root type="single">
    <Accordion.Item value="item-1">
      <Accordion.Trigger>Players</Accordion.Trigger>
      <Accordion.Content>
        <ScrollArea class="h-45">
                ...
                <Drawer.Content>
                  <div class="mx-auto w-full max-w-sm">
                    ...
                    <div class="px-4 space-y-3">
                      <div>
                        <Label for="host-edit-name" class="text-sm text-muted-foreground"
                          >Username</Label
                        >
                        <Input
                          id="host-edit-name"
                      ...
                      <div>
                        <Label for="host-edit-score" class="text-sm text-muted-foreground"
                          >Score</Label
                        >
                        <Input
                          id="host-edit-score"
                    ...
                    <Drawer.Footer>
                      <Drawer.Close
                        ...
                        onclick={saveChanges}>Save</Drawer.Close
                      >
                      <Drawer.Close
                        class={buttonVariants({ variant: "outline" })}
                        onclick={closeDrawer}>Close</Drawer.Close
                      >
                    </Drawer.Footer>
                  </div>
                </Drawer.Content>
